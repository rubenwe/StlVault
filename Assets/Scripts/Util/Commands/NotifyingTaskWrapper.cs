...
namespace StlVault.Util.Commands
{
    ...
    /// </summary>
    internal sealed class NotifyingTaskWrapper : IAsyncExecution
    {
        /// <summary>
        /// Initializes a task notifier watching the specified task.
        /// </summary>
        /// <param name="task">The task to watch.</param>
        private NotifyingTaskWrapper(Task task)
        {
            Task = task;
        ...
        /// </summary>
        /// <param name="task">The task to watch.</param>
        public static NotifyingTaskWrapper Create(Task task)
        {
            return new NotifyingTaskWrapper(task);
        }
        ...
        public static NotifyingTaskWrapper Create(Func<Task> asyncAction)
        {
