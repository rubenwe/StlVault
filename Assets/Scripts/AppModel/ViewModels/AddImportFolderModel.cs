...
{
    internal class AddImportFolderModel : DialogModel<RequestShowAddImportFolderDialogMessage>
    {
        ...
        public BindableProperty<string> Tags { get; } = new BindableProperty<string>{ TransformValue = s => s.ToLowerInvariant() };
