...
namespace StlVault.AppModel.ViewModels
{
    ...
    {
        private readonly ObservableList<SuggestionModel> _autoCompletionSuggestions = new ObservableList<SuggestionModel>();
        ...
        private void AddTag(string tagText)
        {
            ...
            if (_searchedTags.All(tag => tag.Text != tagText))
            {
                ...
                if (exactMatch == null)
                {
                    var alternativeMatch = AutoCompletionSuggestions.FirstOrDefault(suggestion => suggestion.Text.StartsWith(tagText))?.Text;
